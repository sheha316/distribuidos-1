...
var fileDescriptor_db39efb7717b7d47 = []byte{
	...
	,
}
...
// LogicaClient is the client API for Logica service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type LogicaClient interface {
...
func NewLogicaClient(cc grpc.ClientConnInterface) LogicaClient {
	return &logicaClient{cc}
}

func (c *logicaClient) CrearOrdenPyme(ctx context.Context, in *Request_CrearOrdenPyme, opts ...grpc.CallOption) (*Response_CrearOrden, error) {
	out := new(Response_CrearOrden)
	err := c.cc.Invoke(ctx, "/comms.Logica/CrearOrdenPyme", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicaClient) CrearOrdenRetail(ctx context.Context, in *Request_CrearOrdenRetail, opts ...grpc.CallOption) (*Response_CrearOrden, error) {
	out := new(Response_CrearOrden)
	err := c.cc.Invoke(ctx, "/comms.Logica/CrearOrdenRetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicaClient) Seguimiento(ctx context.Context, in *Request_Seguimiento, opts ...grpc.CallOption) (*Response_Seguimiento, error) {
	out := new(Response_Seguimiento)
	err := c.cc.Invoke(ctx, "/comms.Logica/Seguimiento", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicaClient) SolicitarPaquete(ctx context.Context, in *Request_SolicitarPaquete, opts ...grpc.CallOption) (*Response_SolicitarPaquete, error) {
	out := new(Response_SolicitarPaquete)
	err := c.cc.Invoke(ctx, "/comms.Logica/SolicitarPaquete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicaClient) InformarEstado(ctx context.Context, in *Request_Estado, opts ...grpc.CallOption) (*Response_Estado, error) {
	out := new(Response_Estado)
	err := c.cc.Invoke(ctx, "/comms.Logica/InformarEstado", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// LogicaServer is the server API for Logica service.
type LogicaServer interface {
...
// UnimplementedLogicaServer can be embedded to have forward compatible implementations.
type UnimplementedLogicaServer struct {
}

func (*UnimplementedLogicaServer) CrearOrdenPyme(ctx context.Context, req *Request_CrearOrdenPyme) (*Response_CrearOrden, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CrearOrdenPyme not implemented")
}
func (*UnimplementedLogicaServer) CrearOrdenRetail(ctx context.Context, req *Request_CrearOrdenRetail) (*Response_CrearOrden, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CrearOrdenRetail not implemented")
}
func (*UnimplementedLogicaServer) Seguimiento(ctx context.Context, req *Request_Seguimiento) (*Response_Seguimiento, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Seguimiento not implemented")
}
func (*UnimplementedLogicaServer) SolicitarPaquete(ctx context.Context, req *Request_SolicitarPaquete) (*Response_SolicitarPaquete, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SolicitarPaquete not implemented")
}
func (*UnimplementedLogicaServer) InformarEstado(ctx context.Context, req *Request_Estado) (*Response_Estado, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InformarEstado not implemented")
}

func RegisterLogicaServer(s *grpc.Server, srv LogicaServer) {
	s.RegisterService(&_Logica_serviceDesc, srv)
}

func _Logica_CrearOrdenPyme_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request_CrearOrdenPyme)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicaServer).CrearOrdenPyme(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comms.Logica/CrearOrdenPyme",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicaServer).CrearOrdenPyme(ctx, req.(*Request_CrearOrdenPyme))
	}
	return interceptor(ctx, in, info, handler)
}

func _Logica_CrearOrdenRetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request_CrearOrdenRetail)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicaServer).CrearOrdenRetail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comms.Logica/CrearOrdenRetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicaServer).CrearOrdenRetail(ctx, req.(*Request_CrearOrdenRetail))
	}
	return interceptor(ctx, in, info, handler)
}

func _Logica_Seguimiento_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request_Seguimiento)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicaServer).Seguimiento(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comms.Logica/Seguimiento",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicaServer).Seguimiento(ctx, req.(*Request_Seguimiento))
	}
	return interceptor(ctx, in, info, handler)
}

func _Logica_SolicitarPaquete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request_SolicitarPaquete)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicaServer).SolicitarPaquete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comms.Logica/SolicitarPaquete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicaServer).SolicitarPaquete(ctx, req.(*Request_SolicitarPaquete))
	}
	return interceptor(ctx, in, info, handler)
}

func _Logica_InformarEstado_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request_Estado)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicaServer).InformarEstado(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comms.Logica/InformarEstado",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicaServer).InformarEstado(ctx, req.(*Request_Estado))
	}
	return interceptor(ctx, in, info, handler)
}

var _Logica_serviceDesc = grpc.ServiceDesc{
	ServiceName: "comms.Logica",
	HandlerType: (*LogicaServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CrearOrdenPyme",
			Handler:    _Logica_CrearOrdenPyme_Handler,
		},
		{
			MethodName: "CrearOrdenRetail",
			Handler:    _Logica_CrearOrdenRetail_Handler,
		},
		{
			MethodName: "Seguimiento",
			Handler:    _Logica_Seguimiento_Handler,
		},
		{
			MethodName: "SolicitarPaquete",
			Handler:    _Logica_SolicitarPaquete_Handler,
		},
		{
			MethodName: "InformarEstado",
			Handler:    _Logica_InformarEstado_Handler,
		},
	},
